...
\end{tabular}
\begin{tabular}{ | m{3cm} | m{12cm}| } \hline
Flow & 2a. If the actor doesn't select his/her role.
 	\begin{enumerate}
...
Pre-Condition & User must be registered in the system. Forgot Password Form is presented  \\ \hline
Flow & Main Success Scenario (or Basic Flow):
\begin{enumerate}
...
\end{tabular}
\begin{tabular}{ | m{3cm} | m{12cm}| } \hline
Flow & 5a. if the selected role doesn't exist with in existing data
	\begin{enumerate}
		\item Error Signal will be present.
	\end{enumerate}
5b. if the entered username doesn't exist with in existing data
	\begin{enumerate}
		\item Error Signal will be present.
	\end{enumerate}
5c. if the entered password doesn't exist with in existing data
	\begin{enumerate}
		\item Error Signal will be present.
	\end{enumerate}
...
%------------------------------------------
%------------------------------------------
\section{Use Case 4:Detail of Account }

\begin{tabular}{ | m{3cm} | m{12cm}| } \hline

Use Case ID & U04  \\\hline

Name  	    & Detail of Account  \\ \hline
