...
\begin{tabular}{ |c|c|c|c|c|c|c| } 
 \hline
\textbf{ Interface Id} & \textbf{TextBox} & \textbf{DropDown} & \textbf{Password Box} & \textbf{Table} & \textbf{Date Field} &\textbf{Buttons} \\  \hline
...
\textbf{ Interface Id} &\textbf{ AutoComplete} &\textbf{ Radio Button} & \textbf{Check} \textbf{Box} & \textbf{Menu} & \textbf{Text Area} &\textbf{ProgressBar} \\  \hline
...
117 & 0 & 0& 0 & 1 0 & 0 & 0  \\ \hline
118 & 0& 0 & 0 & 1 4 & 0 & 0  \\ \hline
119 & 0 & 0& 0 & 1 1 & 0 & 0  \\ \hline
...
\begin{center} \includegraphics[scale=0.7]{./UIs for Latex Reports/UML.jpg}\end{center}
...
\begin{tabular}{ | m{2cm} | m{3cm}| | m{4cm}|| m{3cm}|} \hline
\textbf{ Use Case Id }& \textbf{Use Case Name} &\textbf{ Member Name}&\textbf{Estimated Completion Date} \\ \hline
